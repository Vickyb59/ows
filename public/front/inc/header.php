            ...
            <div class="row align-items-center">
                <div class="col-xl-3 col-lg-4">
                    <div class="third-logo">
                        <a href="<?= $baseurl; ?>"><img src="img/logo/white_logo.png" alt="Logo"></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6">
                    <div class="logo">
                        <a href="<?= $baseurl ?>"><img src="img/logo/logo.png" class="mobile-logo logo-none" alt="Logo"></a>
                    </div>
                </div>
                <div class="col-lg-9 col-md-6 d-none d-md-block">
                    <div class="menu-area">
                        <div class="main-menu">
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li <?php echo ( $page_name == 'About Us' || $page_parent == 'About Us') ? 'class="active"' : ''; ?>><a href="about-us">Company</a></li>
                                    <li <?php echo ( $page_name == 'Track a Shipment' || $page_parent == 'Track a Shipment') ? 'class="active"' : ''; ?>><a href="track-shipment">Tracking</a></li>
                                    <li <?php echo ( $page_name == 'Service' || $page_parent == 'Service') ? 'class="active"' : ''; ?>><a href="service">Service</a></li>
                                    
                                    <li <?php echo ( $page_name == 'Contact Us' || $page_parent == 'Contact Us') ? 'class="active"' : ''; ?>><a href="support">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="header-btn s-header-btn">
                            <a href="#" class="btn" data-toggle="modal" data-target="#exampleModalLong"><img src="img/icon/calculator-symbols02.png" alt="icon">Quote</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
