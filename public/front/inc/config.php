<?php 	
	...
	//get base url and load files appropriately based on host(local or remote)
		if(
			...
			$baseurl = 'http://localhost/oceanwideshippingco';			
		}  else {			
			$baseurl = 'https://oceanwideshippingco.com/';
		}
	//main url for SEO configurations
	$main_url = 'https://oceanwideshippingco.com/';
	//main website configuration settings
		$settings = (object) array(
			'active' => 'active',
			'siteTitle' => 'Ocean Wide',
			'siteTagline' => 'Delivery and Tracking',
			'phoneNumber' => '',
			'address' => '3909 51st dr w. 34210 Bradenton Florida',
			'address_1' => '3909 51st dr w',
			'address_2' => '34210 Bradenton Florida',
			'email' => 'info@oceanwideshippingco.com',
			'themeColor' => '#f58637',
